...
def handleCmdArgs():
    ...
    parser.add_argument("--waittime", help="wait time in seconds between toggle", type=int, default=1)
    parser.add_argument("--freq", help="frequency in Hz for the PWM signal", type=int, default=50)
    parser.add_argument("--speed", help="speed in percent for the PWM signal", type=int, default=100)
